...
import { buildWhatIfGoals, type WhatIfInput } from "./agent/what-if";
...
async function executeWhatIf(input: WhatIfInput): Promise<string> {
  ...
  // explicit request + cached curriculum. Pure logic + rationale live in
  // ./agent/what-if.ts (buildWhatIfGoals); error results surface verbatim.
