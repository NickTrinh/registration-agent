...
- `notes/degreeworks-api-reference.md` (local-only) — "⭐ What-If audits" section has the full request/response documentation and a ready-to-paste `fetchWhatIfAudit()` sketch.
