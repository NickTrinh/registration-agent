...
| [0024](./0024-the-annotated-worksheet-not-a-chat-app.md) | The annotated worksheet, not a chat app (batched visual redesign) · Lands 0028's Alt B · Amended by 0032 | Accepted | 2026-07-09 |
| [0025](./0025-dark-mode-is-a-token-split-not-an-inversion.md) | Dark mode is a token split, not an inversion (maroon fills; `maroon.ink` writes) · Amended by 0031 (header) | Accepted | 2026-07-09 |
